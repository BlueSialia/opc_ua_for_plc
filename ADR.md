...
In the context of extending the gateway to support new PLC protocols,
...
accepting that changes to the PLC program require manual updates to the gateway's configuration.
