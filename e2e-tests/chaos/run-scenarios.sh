...
# Drop everything to force the gateway's Modbus connection to break.
...
echo "    100% packet loss active, waiting for gateway to detect failure ..."
sleep 6
...
echo "    connectivity restored, waiting for gateway to reconnect ..."
sleep 4
